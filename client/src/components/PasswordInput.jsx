    ...
    <div className="space-y-2">
      ...
      <div className="relative">
        ...
        <input
          ...
          placeholder="••••••••"
          className="w-full bg-[#edeaf5] border-none rounded-2xl py-4 pl-12 pr-12 text-[#4a4658] placeholder-[#a19fb1] focus:ring-2 focus:ring-purple-200 outline-none transition-all"
          required
        />
        <button
          type="button"
          onClick={() => setShowPassword(!showPassword)}
          className="absolute right-4 top-1/2 -translate-y-1/2 text-[#a19fb1] hover:text-[#4a4658] transition-colors"
        >
